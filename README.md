...
> There is deliberately **no** "check for mod updates" option: the mod versions here are pinned to match the settings file the kit writes, so a mod updating itself can stop the games launching. Updates reach you through new releases of this kit.
